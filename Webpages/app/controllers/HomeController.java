...
public class HomeController extends Controller {
    ...
    public Result Products(Long cat) {
        ...
        return ok(Products.render(itemList, categoryList,User.getUserById(session().get("email"))));
    ...
    public Result fillForm() {
        return ok(fillForm.render(User.getUserById(session().get("email"))));
    }
    @Security.Authenticated(Secured.class)
    public Result addProducts() {
        Form<ItemOnSale> itemForm = formFactory.form(ItemOnSale.class);
        return ok(addProducts.render(itemForm,User.getUserById(session().get("email"))));
}
@Security.Authenticated(Secured.class)
@Transactional
public Result addProductsubmit() {
    ...
    if (newItemForm.hasErrors()) {
        ...
        ItemOnSale newProducts = newItemForm.get();
